...
class RewardDecoder(nn.Module):
    def __init__(self,
        ...
        self.drop_input = nn.Dropout(p=dropout_rate)
    ...
    def forward(self, latent_state, next_state, prev_state=None, action=None, add_noise = False):
